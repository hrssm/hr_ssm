...
public interface Config_primary_keyMapper {
	public boolean insertConfig_primary_key(Config_primary_key config_primary_key);
	public boolean updateConfig_primary_key(Config_primary_key config_primary_key);
