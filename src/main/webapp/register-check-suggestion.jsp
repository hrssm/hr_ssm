...
<head>
        ...
        document.humanfileForm.submit();
 		...
 		function back(){
		  window.location.href="../registe-apply-check-list.jsp"; 
		}
	...
	<body>
		<form name="humanfileForm" method="post" action="checkApply.do">
			...
			<table width="100%">
				...
				<tr>
					<td align="right">
						<input type="submit" value="确认录用" class="BUTTON_STYLE1" onclick="search()" >
