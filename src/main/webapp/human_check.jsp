		...
		<table width="100%">
			...
			<tr>
				<td align="right"><input type="submit" value="复核通过"
					...
					onclick="window.location.href='humanFile/queryAll.do'"></td>
			</tr>
		</table>
