...
<html>
	...
	<body>
		<form name="humanfileForm" method="post" action="queryLocateController/queryList.do">
			<table width="100%">
				<tr>
					<td>
			...
			<input type="hidden" value="select" name="query"/>
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td width="84%" class="TD_STYLE2">
						...
						<input type="hidden" vlaue="" name="human_major_kind_name" id="human_major_kind_name">
					</td>
				</tr>
				<tr class="TR_STYLE1">
					<td width="16%" class="TD_STYLE1">
					...
					<td width="84%" class="TD_STYLE2">
						...
						<input type="hidden" vlaue="" name="hunma_major_name" id="hunma_major_name">
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
