    ...
    <title>My JSP 'valid-list.jsp' starting page</title>
		...
		<script type="text/javascript">
			$(window).load(function(){
				window.location.href="engageresume/applyCheckResumeList.do";
			});
		</script>
     </head>
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<tr>
						...
						<td class="TD_STYLE2">
							<%-- <a href="toApplyCheck.do?res_id=${re.res_id}">简历详情</a> --%>
							<a href="checkApplyResume.do?resid=${re.res_id}">简历详情</a>
						</td>
					</tr>
				</c:forEach>
			</table>
