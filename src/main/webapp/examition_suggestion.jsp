...
<head>
        ...
        document.humanfileForm.submit();
 		...
 		function back(){
			window.location.href="../query_examination_result.jsp?backFromResume='back'";
		}
	...
	<body>
		<form name="humanfileForm" method="post" action="testSuggestion.do">
			...
			<table width="100%">
				<tr>
					<td>
						<font color="black">您正在做的业务是：人力资源--招聘管理--招聘考试管理--成绩查询筛选
						</font>
					</td>
				</tr>
				<tr>
					<td align="right">
						<input type="radio" value="4" class="BUTTON_STYLE1" name="pass_check_status">建议面试
						<input type="radio" value="3" class="BUTTON_STYLE1" name="pass_check_status">建议笔试
						<input type="radio" value="2" class="BUTTON_STYLE1" name="pass_check_status">建议录用
						<input type="radio" value="0" class="BUTTON_STYLE1" name="pass_check_status">删除简历
						<input type="submit" value="确认" class="BUTTON_STYLE1" onclick="search()" >
						<input type="button" value="返回" class="BUTTON_STYLE1" onclick="back()">
					</td>
				</tr>
			</table>
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					<td class="TD_STYLE1">
					 ...
					 <td class="TD_STYLE2" >
						<input class="INPUT_STYLE2" value="${avgScore }" readonly="readonly" name="test_amount" id="test_amount">
					</td>
					<%-- <td class="TD_STYLE2" >
						<input class="INPUT_STYLE2" value="${score }" readonly="readonly" name="total_points" id="total_points">
					</td> --%>
					<td class="TD_STYLE1">
						平均成绩
					</td>
					<td class="TD_STYLE2" name="score" id="score">
						<td class="TD_STYLE2" >
							<input class="INPUT_STYLE2" value="${testAmout }" readonly="readonly" name="total_points" id="total_points">
						</td>
					</td>
					<td class="TD_STYLE1">
						筛选人
					</td>
					<td class="TD_STYLE2" name="test_checker" id="test_checker" value="张三">
						
					</td>
					<td class="TD_STYLE1">
						筛选时间
					</td>
					<td class="TD_STYLE2" name="test_check_time" id="test_check_time">
						<input type="text" name="check_time"
							  id="checkTime" readonly="readonly"
							class="INPUT_STYLE2">
					</td>
				</tr>
				 <tr>
					...
					<td colspan="7" class="TD_STYLE2">
						<textarea name="pass_checkComment" rows="4"class="TEXTAREA_STYLE1" id="pass_checkComment"></textarea>
					</td>
				</tr>
			</table>
		</form>
