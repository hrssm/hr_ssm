...
<body>
<form method="post" action="humanFile/picture.do" enctype="multipart/form-data">
<table width="100%" >
  <tr>
    <td colspan="2"> 
  ...
  <tr>
	...
	<input type="file" class="FILE_STYLE1" name="picture" width="100%"></td>
    <td width="41%" align="right">
    <input type="submit" value="上传照片" class="BUTTON_STYLE1" name="human_picture">
